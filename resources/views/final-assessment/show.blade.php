        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($attempt && $attempt->completed_at)
                <div class="bg-white shadow rounded-lg p-6 mb-6">
                    ...
                    <a href="{{ route('final-assessments.result', $attempt->id) }}" class="mt-4 inline-block text-blue-600 hover:text-blue-900">View Results</a>
                </div>
            @endif
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="space-y-2 text-sm text-gray-600">
                    <p><strong>Total Questions:</strong> {{ $assessment->questions->count() }}</p>
                ...
                <div class="mt-6">
                    <a href="{{ route('final-assessments.take', $assessment->id) }}" class="block w-full text-center bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">
                        {{ $attempt && $attempt->completed_at ? 'Retake Assessment' : 'Start Assessment' }}
                    </a>
                </div>
            </div>
        </div>
