<x-layouts.app title="Add Question">
    <div class="py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Add Question to Quiz</h1>
                <p class="mt-2 text-gray-600">Quiz: {{ $quiz->title }}</p>
            </div>

            <div class="bg-white shadow rounded-lg p-6">
                <form action="{{ route('admin.quizzes.store-question', $quiz->id) }}" method="POST">
                    @csrf
